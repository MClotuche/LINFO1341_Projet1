...
name="$1"
capture_file_bg="Mhome_captures/raw_bg/${name}_bg_capture.pcap"
capture_file_chrome="Mhome_captures/raw_chrome/${name}_chrome_capture.pcap"
ssl_log_file="Mhome_captures/keys/${name}_log.txt"
...
#SSLKEYLOGFILE="$ssl_log_file" firefox https://onedrive.live.com/ &
#SSLKEYLOGFILE="$ssl_log_file" vivaldi https://onedrive.live.com/ &
#SSLKEYLOGFILE="$ssl_log_file" opera https://onedrive.live.com/ &
